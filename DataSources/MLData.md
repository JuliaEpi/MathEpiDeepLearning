[这些超全的SCI论文数据网站来了！！推荐收藏~~](https://mp.weixin.qq.com/s/_hwCEm1zdpGDltVd0DWTzQ)
...
[tensorflow/datasets: TFDS is a collection of datasets ready to use with TensorFlow, Jax, ...](https://github.com/tensorflow/datasets)
